...
class StayUnitGraphQLController(
	...
	fun getStayUnitById(
		@Argument id: Long,
	): StayUnitResponse? = stayUnitService.getStayUnitById(id)

	@QueryMapping
	fun getStayUnitsByStayId(
		@Argument stayId: Long,
	): List<StayUnitResponse> = stayUnitService.getStayUnitsByStayId(stayId)
	...
	): List<StayUnitResponse> = stayUnitService.searchAvailableUnits(stayId, minCapacity, maxPrice)
}
